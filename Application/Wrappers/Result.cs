...
namespace Application.Wrappers
{
    ...
    public class Result<T> : Result, IResult<T>
    {
        ...
        {
            return new Result<T> { Succeeded = true, Response = data };
        }

        public static Result<T> Success(T data, string message)
        {
            return new Result<T> { Succeeded = true, Response = data, Messages = new List<string> { message } };
        }

        public static Result<T> Success(T data, List<string> messages)
        {
            return new Result<T> { Succeeded = true, Response = data, Messages = messages };
        }
